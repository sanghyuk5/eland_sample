...
class GoodsDetailSellerRecommendViewHolder(
    ...
    private inner class GoodsAdapter
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            return ViewHolder(
                ViewItemGoodsDetailSellerRecommendBinding.inflate(
        ...
        private inner class ViewHolder(val binding: ViewItemGoodsDetailSellerRecommendBinding) :
