...
import com.pionnet.eland.databinding.ViewItemGoodsDetailSellerPopularBinding
...
class GoodsDetailSellerPopularViewHolder(
    ...
    private inner class GoodsAdapter
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            return ViewHolder(
                ViewItemGoodsDetailSellerPopularBinding.inflate(
        ...
        private inner class ViewHolder(val binding: ViewItemGoodsDetailSellerPopularBinding) :
